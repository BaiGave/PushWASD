...
void EmptyLinkFunctionForGeneratedCodePaperZD_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_PaperZD()
	{
		if (!Z_Registration_Info_UPackage__Script_PaperZD.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_PaperZD_PaperZDPlaySlotOverrideOutputSignature__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_PaperZD(Z_Construct_UPackage__Script_PaperZD, TEXT("/Script/PaperZD"), Z_Registration_Info_UPackage__Script_PaperZD, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x98F3D76C, 0xA40030CA));
