...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UPaperZDAnimationSource_Flipbook);
UClass* Z_Construct_UClass_UPaperZDAnimationSource_Flipbook_NoRegister()
{
	return UPaperZDAnimationSource_Flipbook::StaticClass();
}
...
template<> PAPERZD_API UClass* StaticClass<UPaperZDAnimationSource_Flipbook>()
{
	return UPaperZDAnimationSource_Flipbook::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PaperZD_Source_PaperZD_Public_AnimSequences_Sources_PaperZDAnimationSource_Flipbook_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPaperZDAnimationSource_Flipbook, UPaperZDAnimationSource_Flipbook::StaticClass, TEXT("UPaperZDAnimationSource_Flipbook"), &Z_Registration_Info_UClass_UPaperZDAnimationSource_Flipbook, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPaperZDAnimationSource_Flipbook), 3233553958U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PaperZD_Source_PaperZD_Public_AnimSequences_Sources_PaperZDAnimationSource_Flipbook_h_231944984(TEXT("/Script/PaperZD"),
	Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PaperZD_Source_PaperZD_Public_AnimSequences_Sources_PaperZDAnimationSource_Flipbook_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PaperZD_Source_PaperZD_Public_AnimSequences_Sources_PaperZDAnimationSource_Flipbook_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
